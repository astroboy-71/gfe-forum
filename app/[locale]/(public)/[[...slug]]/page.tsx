...
export default function Page({ params }: { params: { slug: string[] } }) {
  ...
  return (
    <div className="w-full px-2">
      <h1 className="mx-auto mt-4 bg-gradient-to-b from-[#2BADFD] to-[#1570EF] bg-clip-text text-center font-goldman text-3xl tracking-wider text-transparent sm:text-4xl">
